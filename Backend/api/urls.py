...
urlpatterns = [
    ...
    path('demandes/expirees/<str:username>/', DemandeExpireesList.as_view()),


    path('demandes/create/', DemandeCreate.as_view()),
    path('demandes/update/<int:id>/', DemandeUpdate.as_view()),
    path('demandes/delete/<int:id>/', DemandeDelete.as_view()),
    ...
    path('demandes/validation-admin/<int:id>/<str:username>/<str:password>/', ValidationAdmin.as_view(), name="validation-admin-demande"),

    #Refus (Hierarchie / Securite)
    path('demandes/refus-hierarchie/<int:id>/<str:motif>/', RefusHierarchie.as_view(), name="refus-hierarchique-demande"),
    path('demandes/refus-securite/<int:id>/<str:motif>/', RefusSecurite.as_view(), name="refus-securite-demande"),
